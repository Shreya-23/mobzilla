...
<%@ include file="NavigationBanner.jsp"%>
	<div class="container">
		...
		<hr class="custom">
			...
			<div class="row">
				<div class="col-lg-4"><h3>Shipping Details</h3><br>
                                                     <p>Address : </p>
                                                     <p> <c:out value="${addres.addressLine1}"/> </p>
                                                     <p> <c:out value="${addres.addressLine2}"/> </p>
                                                     <p>City :</p>
                                                     <p> <c:out value="${addres.city}"/> </p>
                                                     <p>State : </p>
                                                     <p> <c:out value="${addres.state}"/> </p>
                                                     <p>Pin Code : </p>
                                                     <p> <c:out value="${addres.pin}"/> </p>
                                                      </div>
		...
		<div class="col-lg-4" style="border-left: 1px solid gray ;">
			...
			<h3>Total Amount :<c:out value="${grandTotal}"></c:out> </h3><hr>
			<a href="order.shop">
